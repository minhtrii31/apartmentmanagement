...
SECRET_KEY = 'django-insecure-gs3$&^0bg1&l3z^uuh3xlqeqov3s$d3!-vccjxk15w^to+$+)f'
...
cloudinary.config(
    cloud_name="dwt3g6lgh",
    api_key="538139629775244",
    api_secret="6rgAHqJo7VWzgSy3tK3niw2wusE",
    secure=True
)